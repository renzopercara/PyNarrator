...
from src.config import OUTPUT_DIR, AUDIO_DIR, MUSIC_DIR, SFX_DIR, VIDEO_RES, LOGO_PATH
...
async def main():
    ...
    try:
        ...
        # 6. Generar subtítulos con Whisper (también retorna tiempos de segmento para SFX)
        ...
        subtitle_clips, subtitle_segment_times = generate_subtitles(
            audio_path, return_segment_times=True
        )
        ...
        # 8.5. Añadir placa de cierre CTA (2 segundos al final)
